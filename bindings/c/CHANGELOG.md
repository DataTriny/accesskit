...
## [0.5.0](https://github.com/DataTriny/accesskit/compare/accesskit_c-v0.4.0...accesskit_c-v0.5.0) (2023-05-29)
...
* Add CMake support to C bindings ([8c20843](https://github.com/DataTriny/accesskit/commit/8c20843a2de49b79f7295662f9eee63dc42acf12))
...
* The following workspace dependencies were updated
  * dependencies
    * accesskit_windows bumped from 0.15.0 to 0.16.0
    * accesskit_macos bumped from 0.8.0 to 0.9.0
    * accesskit_unix bumped from 0.6.0 to 0.7.0

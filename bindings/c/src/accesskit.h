...
typedef struct accesskit_node_class_set {
  uint8_t _private[0];
} accesskit_node_class_set;

typedef struct accesskit_node {
  uint8_t _private[0];
} accesskit_node;

typedef struct accesskit_node_builder {
  uint8_t _private[0];
} accesskit_node_builder;
...
typedef struct accesskit_action_handler {
  uint8_t _private[0];
} accesskit_action_handler;
...
typedef struct accesskit_macos_queued_events {
  uint8_t _private[0];
} accesskit_macos_queued_events;
#endif

#if defined(__APPLE__)
typedef struct accesskit_macos_adapter {
  uint8_t _private[0];
...
typedef struct accesskit_unix_adapter {
  uint8_t _private[0];
} accesskit_unix_adapter;
#endif

#if defined(_WIN32)
typedef struct accesskit_windows_uia_init_marker {
  uint8_t _private[0];
} accesskit_windows_uia_init_marker;
#endif

#if defined(_WIN32)
typedef struct accesskit_windows_queued_events {
  uint8_t _private[0];
} accesskit_windows_queued_events;
#endif

#if defined(_WIN32)
typedef struct accesskit_windows_adapter {
  uint8_t _private[0];
...
#if defined(__APPLE__)
accesskit_NSArray<accesskit_NSObject> *accesskit_macos_adapter_view_children(const struct accesskit_macos_adapter *adapter);
#endif

#if defined(__APPLE__)
accesskit_NSObject *accesskit_macos_adapter_focus(const struct accesskit_macos_adapter *adapter);
#endif

#if defined(__APPLE__)
accesskit_NSObject *accesskit_macos_adapter_hit_test(const struct accesskit_macos_adapter *adapter,
                                                     accesskit_NSPoint point);
#endif

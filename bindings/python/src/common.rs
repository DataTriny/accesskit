...
unique_enum_property_methods! {
    (accesskit::NameFrom, name_from, set_name_from, clear_name_from),
    (accesskit::DescriptionFrom, description_from, set_description_from, clear_description_from),
    (accesskit::Invalid, invalid, set_invalid, clear_invalid),
    (accesskit::CheckedState, checked_state, set_checked_state, clear_checked_state),
